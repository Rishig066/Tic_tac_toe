package com.sharktm11.tictactoe;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scoreA=findViewById(R.id.scoreX);
        scoreB=findViewById(R.id.scoreY);
        ...
        Reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                xCount=0;
                oCount=0;
                scoreA.setText("Score X :-"+String.valueOf(xCount));
                scoreB.setText("Score O :-"+String.valueOf(oCount));
            }
        });
    ...
    private void winningGame() {
        if((b1==1)&&(b2==1)&&(b3==1))
        {
            ...
            builder.setMessage("x win").setCancelable(false).setPositiveButton("ok", new DialogInterface.OnClickListener() {
                @Override
        ...
        {
            AlertDialog.Builder builder=new AlertDialog.Builder(this);
            builder.setMessage("o win").setCancelable(false).setPositiveButton("ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    button1.setImageDrawable(null);
                    button2.setImageDrawable(null);
        ...
        else if((b3==0)&&(b5==0)&&(b7==0))
        {
            ...
            {
                AlertDialog.Builder builder=new AlertDialog.Builder(this);
                builder.setMessage("no one win play again").setCancelable(false).setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        button1.setImageDrawable(null);
                        button2.setImageDrawable(null);
